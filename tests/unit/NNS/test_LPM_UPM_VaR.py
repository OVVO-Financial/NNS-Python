...
class TestLPM_UPM_VaR(unittest.TestCase):
    ...
    def assertAlmostEqualArray(
        ...
        places: [int, float, None] = 7,
        delta: [int, float, None] = None,
    ) -> None:
        self.assertEqual(len(x), len(y))
        if isinstance(x, dict):
            for i in x.keys():
                self.assertAlmostEqual(x[i], y[i], places=places, delta=delta)
        else:
    ...
    def test_LPM_VaR(self):
        ...
        self.assertAlmostEqualArray(
            LPM_VaR(percentile=np.arange(0, 1.01, 0.01, ), degree=2, x=x),
            [
                1.000081, 2.000000, 2.274171, 2.442890, 2.571804, 2.678429, 2.770489, 2.852261, 2.926220, 2.994068, 3.056480, 3.113683, 3.166731, 3.216428, 3.263278,
                3.307651, 3.349941, 3.390462, 3.429385, 3.466873, 3.503164, 3.538326, 3.572446, 3.605709, 3.638145, 3.669849, 3.700929, 3.731338, 3.761221, 3.790587,
                3.819505, 3.848023, 3.876172, 3.903956, 3.931421, 3.958598, 3.985595, 4.012297, 4.038779, 4.064962, 4.091003, 4.116805, 4.142437, 4.167964, 4.193316,
                4.218594, 4.243772, 4.268899, 4.293971, 4.319050, 4.344083, 4.369128, 4.394170, 4.419329, 4.444530, 4.469804, 4.495167, 4.520625, 4.546268, 4.572074,
                4.598044, 4.624211, 4.650607, 4.677264, 4.704194, 4.731442, 4.758977, 4.786906, 4.815215, 4.843965, 4.873173, 4.902901, 4.933196, 4.964063, 4.995622,
                5.027840, 5.060848, 5.094757, 5.129598, 5.165461, 5.202433, 5.240692, 5.280384, 5.321660, 5.364696, 5.409725, 5.457102, 5.507129, 5.560221, 5.617014,
                5.678189, 5.744793, 5.818196, 5.900525, 5.995124, 6.104669, 6.232017, 6.386082, 6.586040, 6.891559, 7.999932
            ],
            places=None,
            delta=0.01
        )
